...
from Burn_Scar_Detection_Utils import validate_FIRMS
from shapely.geometry import Point

# Use absolute paths
BASE_DIR = r"C:\Tarig\work\CIR\Sudan Witness\FIRMS Automation WorkSpace\Arson_Analyser"
FIRMS_DATA_PATH = os.path.join(BASE_DIR, "Data", "FIRMS_Detections_2024_05_01_to_2024_05_19.geojson")
URBAN_FILTER_PATH = os.path.join(BASE_DIR, "Data", "Sudan_Filterer_Cleaned_Dissolved.gpkg")
OUTPATH_POLYGONS = os.path.join(BASE_DIR, "Outputs", "Validated_FIRMS_Detections_Town_Polygons_2024_04_01_to_2024_04_15.geojson")
OUTPATH_POINTS = os.path.join(BASE_DIR, "Outputs", "Validated_FIRMS_Detections_Points_2024_04_01_to_2024_04_15.geojson")
...
print(f'A total of {urban_firms_detections.sum()} fires detected by FIRMS in urban areas.')
...
validated_firms_polygons, validated_firms_detections_points = arson_analyser(urban_firms_detections_gdf)
